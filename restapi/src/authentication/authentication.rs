use actix_web::{
    Error, HttpMessage, HttpResponse, body::BoxBody, dev::{ServiceRequest, ServiceResponse}, http::header::{AUTHORIZATION, HeaderName}, middleware::Next, web
};
use chrono::Utc;
use jsonwebtoken::{Algorithm, DecodingKey, EncodingKey, Header, Validation, decode, encode};
use uuid::Uuid;

use object::interfaces::authentication::{ApiKeyConfig, AuthContext, Claims, JwtConfig, Role};
